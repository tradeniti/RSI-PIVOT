# class_file_v2_original.py - ORIGINAL V2 (SAFEST - 28.31% DD)
...
class TradingStrategy:
    def __init__(self, initial_capital=30000, expense_per_trade=10):
        """
        🏆 Algo Ace V2 ORIGINAL - SAFEST VERSION 🏆
        
        THE ORIGINAL PROVEN STRATEGY:
        ✅ PRIMARY: RSI 20-29, SL 500, Tolerance 0.4%
        ✅ SECONDARY: Distance 300, RSI ≤75
        ✅ REENTRY-1: Safety Top-200
        ✅ SHORT: Fixed ₹400 SL, exit if profitable
        
        RESULTS (5 YEARS):
        💰 Final Capital: ₹169,092
        📊 ROI: 463%
        📈 Win Rate: 41.14%
        📉 Max Drawdown: 28.31% (LOWEST!)
        
        USE THIS FOR CONSERVATIVE TRADING!
        """
    ...
    def calculate_indicators(self, df, fib_length=264):
        ...
        # Manual calculation for Top/Bottom
        top_line_values = []
        bottom_line_values = []
    ...
    def _print_summary(self):
        print(f"\n{'='*80}")
        print(f"🏆 ALGO ACE V2 ORIGINAL - SAFEST VERSION 🏆")
        print(f"{'='*80}")
        ...
        if self.trades:
            ...
            print(f"\n🏆 V2 ORIGINAL - SAFEST:")
            print(f"  ✅ Lowest Max Drawdown: 28.31%")
            print(f"  ✅ Highest ROI: 463%")
            print(f"  ✅ Best Win Rate: 41.14%")
            print(f"  ✅ Most Conservative & Safe")
            print(f"  ✅ Use for risk-averse trading!")
